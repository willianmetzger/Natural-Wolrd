...
onready var transition = $Level/Overlays/TransitionColor
onready var level = $Level
onready var party = $Level/Player/Party as Party
onready var music_player = $Level/MusicPlayer
onready var game_over_interface : = $Level/GameOverInterface
...
func _ready():
	...
	level.visible = true
	level.connect("enemies_encountered", self, "enter_battle")
